...
const HERO_EYE = {
  // idle's ly/ry carry +0.065: the baked figurine pedestal was cut out of the
  // cell (2026-08-16) and the body settled 11px down onto the cell floor —
  // the eyes moved with it
  ...
  charge:      { lx: 0.544, ly: 0.379, rx: 0.617, ry: 0.383, ew: 0.034, eh: 0.050 },
