  ...
  function apply(ops) {
    ...
    for (const op of Array.isArray(ops) ? ops : [ops]) {
      ...
      if (op.op === 'new_room') {
        ...
        F.pack.rooms[op.id] = { zone: op.zone || 'A', w, h, exits: {}, ents: [], grid: rows };
