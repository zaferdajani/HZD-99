...
const THREAT = { crawler: 1, hopper: 1, flier: 2, turret: 2, blob: 2, guard: 3, surge: 2 };
const ROLE = { crawler: 'pressure', hopper: 'pressure', flier: 'disruptor', turret: 'zoner', blob: 'denial', guard: 'anchor', surge: 'zoner' };
