...
it. Republish the artifact first (same file path keeps the same URL), then
paste the link. The standing links:

- **Game (play on desktop or phone)**: https://claude.ai/code/artifact/e90a6fc8-ae94-49cd-9181-add016d372c1
  — republish from `play.html` (strip outer html/head/body into the artifact
  file first; the wrapper adds its own skeleton).
