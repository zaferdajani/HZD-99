...
const files = ['vendor-three', 'model3d', 'beast', 'eagle', 'glaciere', 'theme', 'mat', 'prism', 'types', 'i18n', 'media', 'atlas', 'audio', 'engine', 'lang', 'riddles', 'trials', 'world', 'entities', 'game', 'touch']
