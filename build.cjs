...
const files = ['beast', 'eagle', 'glaciere', 'furnace', 'mother', 'theme', 'mat', 'prism', 'types', 'i18n', 'weapons', 'gear', 'media', 'quests', 'atlas', 'audio', 'engine', 'lang', 'riddles', 'trials', 'world', 'preload', 'entities', 'wolves', 'pets', 'braid', 'game', 'perf', 'touch', 'packs', 'warp', 'diag']
